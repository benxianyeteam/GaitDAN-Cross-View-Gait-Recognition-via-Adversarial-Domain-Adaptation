...
def load_data(dataset_path, resolution, dataset, pid_num, pid_shuffle, cache=True):
    ...
    for _label in sorted(list(os.listdir(dataset_path))):
        ...
        for _seq_type in sorted(list(os.listdir(label_path))):
            ...
            for _view in sorted(list(os.listdir(seq_type_path))):
                '''gait'''
                '''
                if dataset == 'CASIA-B' and int(_label)<75 and _view == '126':
                    continue
                '''
    ...
    if dataset == 'CASIA-B' or dataset == 'OULP':
        ...
        if not osp.exists(pid_fname):
            ...
            print('pid_num:{}'.format(pid_num))
            pid_list = [pid_list[0:pid_num], pid_list[74:]]
        ...
        test_list = pid_list[1]
        '''
        exclude_list = ['00404', '00568', '02338', '02748', '03198', '03508', '03598', '03682', '03744',
                        '04334', '04544', '04572', '04634', '04640', '04646', '04656', '04660', '04662',
                        '05270', '05982', '06544', '06752', '06906', '07032', '07114', '07412', '07462',
                        '08988', '09044', '09200', '09304', '10284']
        test_list = list(set(test_list) - set(exclude_list))
        '''
