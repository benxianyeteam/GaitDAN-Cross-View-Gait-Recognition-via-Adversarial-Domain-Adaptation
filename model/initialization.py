...
#from .model import Model, Model_1
#from .model_tri_cse import Model_tri_cse   #############
from .model_tri_cse_grl import Model_tri_cse_grl
#from .model_grl import Model_grl
#from .model_view import Model_view
#from .model_view_tri_cse0 import Model_view_tri_cse0
...
def initialize_model(config, train_source, test_source):
    ...
    m = Model_tri_cse_grl(**model_param)    ###################
    #m = Model_view(**model_param)
    #m = Model(**model_param)
    #m = Model_grl(**model_param)
    #m = Model_view_tri_cse(**model_param)
    #m = Model_tri_cse_grl(**model_param)
...
def initialization(config, train=False, test=False):
    ...
    #seed = 0            #second-1 seed1-0/seed2-10/seed3-20/seed4-40/seed5-50  3407
    #np.random.seed(seed)
    ...
    #random.seed(seed)
    #cudnn.deterministic = True  ####固定每次返回的卷积实现算法
...
def initialization(config, train=False, test=False):
    ...
    #seed = 50            #second-1 seed1-0/seed2-10/seed3-20/seed4-40/seed5-50
    #np.random.seed(seed)
    #torch.manual_seed(seed)
    #torch.cuda.manual_seed(seed)
    #torch.cuda.manual_seed_all(seed)
